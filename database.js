...
class Verb {
    constructor(verb, defenition, includeY) {
        ...
        const html = CreateVerbElement(this);
        const place = verbs.push(this);
        process(html, place, this)
    }
}

function process(html, place, data) {
    ...
    main.call({html: html, color: color, verb: data})
}
